...
abstract contract codeconstants {
    ...
    uint256 public constant LOCAL_CHAINID_ID = 31337;
}
...
contract Helperconfig is codeconstants, Script {
    ...
    function getConfigByChainId(uint256 chainId) public returns (NetworkConfig memory) {
        ...
        } else if (chainId == LOCAL_CHAINID_ID) {
    ...
    function getSepoliaEthConfig() public pure returns (NetworkConfig memory) {
        return NetworkConfig({
            ...
            subscriptionId: 72250136697754528698453995884793789411493546765439396937576716599418574648905,
            callbackGasLimit: 500000,
            link: 0x779877A7B0D9E8603169DdbD7836e478b4624789,
            account:0x80C6F0d107695d3E9010133eCDAd420fF0C78529
        });
    }
